...
namespace ServiceReference1
{
    ...
    public interface ICalculatorService
    {
        ...
        System.Threading.Tasks.Task<double> SubtractAsync(double val1, double val2);
    }
    ...
    public partial class CalculatorServiceClient : System.ServiceModel.ClientBase<ServiceReference1.ICalculatorService>, ServiceReference1.ICalculatorService
    {
        ...
        public System.Threading.Tasks.Task<double> SubtractAsync(double val1, double val2)
        {
            return base.Channel.SubtractAsync(val1, val2);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ICalculatorService))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:8080/CalculatorService");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
